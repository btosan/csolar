...
<section className="container mx-auto py-16">
  ...
  <div className="overflow-hidden">
    <div className="flex py-6 gap-6">
      {Array.from({ length: 6 }).map((_, i) => (
        <div
          key={i}
          className="shrink-0 w-[320px] bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm animate-shimmer"
        >
          {/* Image */}
  ...
  return (
    <section className="container mx-auto py-16">
      ...
      <p className="mb-10 text-center text-base md:text-lg lg:text-xl">
        New Arrivals
      </p>
