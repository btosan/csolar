...
export const metadata = {
  title:
    "Contained Solar | Contained Energy | Solar Installation, Inverters & Energy Solutions",
  ...
  keywords:
    "Contained Energy, Contained Energy Services Ltd, Contained Energy Services, Contained Solar, solar installation, solar panels, inverter systems, solar energy solutions, renewable energy, off-grid solar, hybrid solar systems, solar maintenance, solar consulting, residential solar, commercial solar",
